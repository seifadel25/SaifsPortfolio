const data = [
  ...
  },
  {
    ...
    description:
      " A full Platform for a General Contracting company Showcasing their services, projects and clients using Next.js and Tailwind CSS for the frontend and using Next.js API routes",
    skills: [
      { id: 1, name: "next", image: "/images/skills/next-js.png" },
      { id: 2, name: "tailwindcss", image: "/images/skills/tailwind.png" },
